...
public abstract class AbstractSort<T extends Comparable<T>> {
    ...
    /** @return the total number of comparisons performed during sorting */
    public long getComparisons(){
        return comparisons;
    }

    /** @return the total number of assignments performed during sorting */
    ...
    /** Sorts the array in ascending order, from beginning to end
     * @param array an array of comparable keys
     */
    ...
    /** Sorts the array from one point to another point
     * @param array an array of comparable keys
     * @param beginIndex the index of first key to be sorted (inclusive)
